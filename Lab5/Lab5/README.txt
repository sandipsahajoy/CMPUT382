...
Step 1: First build your program with the "Submission" configuration selected and make sure the folder "Submission" exists. The path to the executable should be: Submission/Lab5.exe
...
Lab5.sln - The Visual Studios solution.
...
Lab5 - Contains the Visual Studios project and source code for Lab5.
